...
def login_page():
    ...
    <div class="main-header">
        <h1>🦂DAVY XD </h1>
        <p>END TO END (E2EE) SULTANPURIYA  CONVO SYSTEM</p>
    </div>
...
def main_app():
    ...
    <div class="main-header">
        <h1>🦂 DAVY XD  </h1>
        <p>FACEBOOK SULTANPURIYA E2EE CONVO SERVER SYSTEM </p>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown('<div class="footer">MADE EDIT BY DAVY 🇮🇳 WP+917652884120</div>', unsafe_allow_html=True)
